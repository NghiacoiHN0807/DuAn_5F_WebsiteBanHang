...
const ModalAddAddress = () => {
    ...
    return (
        <>
                                    ...
                                    return (
                                        ...
                                        <TableRow key={index}>
                                            <TableCell component="th" scope="row" align="left">
                                                <div>
                                                    <div><span
                                                        style={{fontSize: '20px'  ,fontWeight: 'bold'}}>{tenNguoiNhan}</span> | {sdt}</div>
                                                    <div>{diaChiCuThe}</div>
                                                    <div>
            ...
            />
            <ModalsUpdateAddressById open={showModalsUpdate} handleClose={handleCloseUpdate} getAllData={getAllData} idDC={idDC} />
            <Dialog
                open={open}
                onClose={handleClose}
