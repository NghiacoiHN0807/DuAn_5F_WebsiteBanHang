...
public class LoaiCoAoController {
    ...
    @PostMapping("add")
    public ResponseEntity<?> add(@Valid @RequestBody LoaiCoAo loaiCoAo,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return ResponseEntity.ok(loaiCoAoService.add(loaiCoAo));
        }
    }
    ...
    @PutMapping("update")
    public ResponseEntity<?> update(@Valid @RequestBody LoaiCoAo loaiCoAo,
                                    BindingResult bindingResult) {
        ...
        if (bindingResult.hasErrors()) {
            ...
            return ResponseEntity.ok(loaiCoAoService.update(loaiCoAo));
        }
    }
}
