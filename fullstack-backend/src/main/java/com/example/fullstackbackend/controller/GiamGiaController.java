...
public class GiamGiaController {
    ...
    @GetMapping("view")
    Page<GiamGia> view(@RequestParam(value = "page", defaultValue = "0") Integer pageNo, @RequestParam(value = "size", defaultValue = "5") Integer size) {
        return giamGiaService.getAll(pageNo, size);
    }
