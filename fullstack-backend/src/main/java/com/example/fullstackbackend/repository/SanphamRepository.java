...
public interface SanphamRepository extends JpaRepository<SanPham, Integer> {
    ...
    @Query(value = "SELECT \n" +
            ...
            "                        WHERE \n" +
            "                            ctsp.gia_ban = ctsp.gia_thuc_te AND ctsp.trang_thai = 0\n" +
            "                        GROUP BY \n" +
    ...
    @Query(value = "SELECT  \n" +
            ...
            "                                    WHERE  \n" +
            "                                        gg.id_giam_gia = 6 AND (ggct.trang_thai = 0 OR ggct.trang_thai = 1) AND ctsp.trang_thai = 0\n" +
            "                                    GROUP BY  \n" +
            "                                        sp.id_sp, sp.ten_sp, ggct.trang_thai", nativeQuery = true)
    ...
    @Query(value =
            "SELECT \n" +
                    ...
                    "                    WHERE \n" +
                    "                        giam_gia_chi_tiet.trang_thai = 0 OR giam_gia_chi_tiet.trang_thai = 1 AND chi_tiet_san_pham.trang_thai = 0\n" +
                    "                    GROUP BY \n" +
                    "                        san_pham.id_sp, \n" +
                    "                        san_pham.ten_sp,\n" +
                    "                        giam_gia.ten_chuong_trinh,\n" +
    ...
    @Query(value = "SELECT \n" +
            ...
            "                                      GROUP BY id_sp\n" +
            "                                    ) ctsp ON sp.id_sp = ctsp.id_sp\n" +
            "                                    WHERE (sp.trang_thai = 0 OR sp.trang_thai = 1) AND min_gia_ban > giam_gia AND ct.so_luong_ton > 0 AND ct.trang_thai = 0\n" +
    ...
    @Query(value = "SELECT \n" +
            ...
            "            WHERE (sp.trang_thai = 0 OR sp.trang_thai = 1) AND (hd.trang_thai = 5 OR hd.trang_thai = 9) AND (hdct.trang_thai = 0) AND ct.so_luong_ton > 0 AND ct.trang_thai = 0\n" +
