...
public interface HoadonchitietRepository extends JpaRepository<HoaDonChiTiet, Integer> {
    ...
    @Query(value = "SELECT hd.id_hd, hdct.id_hdct, GROUP_CONCAT(DISTINCT img.images ORDER BY img.images ASC) AS img, sp.id_sp, sp.ma_sp, sp.ten_sp, GROUP_CONCAT(DISTINCT s.ten_size ORDER BY s.ten_size ASC) AS size, ct.gia_thuc_te, hdct.so_luong, hdct.don_gia, ct.id_ctsp\n" +
