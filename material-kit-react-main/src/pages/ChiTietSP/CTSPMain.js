...
import { fetchAllCTSP } from '../../service/ChiTietSPService';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'tenSp', label: 'Tên sản phẩm', alignRight: false },
  { id: 'chatLieu', label: 'Chất liệu', alignRight: false },
  { id: 'mauSac', label: 'Màu sắc', alignRight: false },
  { id: 'loaiSp', label: 'Loại sản phẩm', alignRight: false },
  { id: 'xuatXu', label: 'Xuất xứ', alignRight: false },
  { id: 'coAo', label: 'Cổ áo', alignRight: false },
  ...
  { id: 'fun', label: 'Funciton', alignRight: false },
  { id: '' },
];
...
export default function UserPage() {
  ...
  const getListData = async (page) => {
    try {
      const res = await fetchAllCTSP(page);
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = listCTSP.map((n) => n.name);
  ...
  const filteredUsers =
    listCTSP && listCTSP.content ? applySortFilter(listCTSP.content, getComparator(order, orderBy), filterName) : [];
